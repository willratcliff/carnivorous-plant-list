...
const plants = [
...

  {
    ...
    species: "",
    price: { small: "$10" },
    shortDescription: "A pastel selection of P. ehlersiae — creamy white rosettes blushed with soft pink. Offered as small (~1.5 cm) for $10.",
  ...
  {
    name: "Pinguicula agnata 'El Lobo'",
    category: "pinguicula",
    species: "",
    price: { medium: "$20", large: "$30" },
    shortDescription: "A big, pale Mexican butterwort. Broad yellow-green leaves edged in red, every one glistening with mucilage. Medium $20, large $30.",
    description: "Pinguicula agnata 'El Lobo' is one of the larger Mexican butterworts, and the photo shows the stock tray: broad, rounded, yellow-green leaves with a thin red margin, lying nearly flat and covered edge to edge in the sticky glands that make these plants so good at catching fungus gnats. Under strong light the leaves stay pale and the red edge deepens.\n\nIt grows like the rest of the Mexican butterworts: a mineral-based mix, bright light, and good airflow. Buyers receive a single plant from stock like this, not the tray shown. Two sizes are offered, medium for $20 and large for $30.",
    image: "images/agnata-el-lobo.jpg",
    images: [],
    status: "new",
  },
...

  {
    ...
    images: [
      ...
      { label: "Light Detail",  file: "images/led-grow-light-stake-2.jpg" },
    ],
    status: "available",
  },

  {
    ...
    kitPlantPicker: true,
    priceTiers: [
      { label: "Kit with Plant of Your Choice",  price: "$30", pick: true },
      { label: "Kit with Sundew (D. binata)",  price: "$30" },
    ],
    shortDescription: "A plant of your choice, 2.5\" pot, peat moss, and grow light. Flytraps, sundews and butterworts ship bare root, so you pot them up and learn the basics yourself. Nepenthes ship potted.",
    description: "This kit has everything a beginner needs to start growing carnivorous plants: a healthy plant of your choice (any available Venus flytrap clone, <em>Nepenthes</em>, or Mexican butterwort, or a <em>Drosera binata</em> var. multifida extrema sundew), a 2.5\" pot, peat moss, and a grow light.\n\nFlytraps, sundews and butterworts ship bare root, not pre-potted. That is intentional. Potting one up yourself takes five minutes and teaches you exactly how these plants want to be grown, which will pay off every year when repotting and dividing season comes around. In our experience, bare root shipping is also a more reliable way to ship flytraps — the plants travel lighter, stay drier, and arrive in better condition. Nepenthes are the exception: those ship potted in sphagnum, ready to grow.\n\nIf you choose the plant-of-your-choice option, the dropdown lists everything currently eligible: Venus flytrap clones, <em>Nepenthes</em>, and Mexican butterworts. The sundew option is a division of <em>Drosera binata</em> var. multifida extrema, one of the easiest and most spectacular sundews in cultivation. Both are forgiving growers that do well under the included grow light.",
